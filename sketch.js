...
function initialise(){
  ...
  for(var i = 0 ; i < 10 ; i++){
      images[i] = new imageItem("piece_img/2000px-Chess_Pieces_Sprite_0" + i + ".png")
  }
  for (var i = 10; i < 13; i++) {
    images[i] = new imageItem("piece_img/2000px-Chess_Pieces_Sprite_" + i + ".png");
  }
}
...
function setup() {
  ...
  loadImage("piece_img/2000px-Chess_Pieces_Sprite_" + "3" + ".png")
}
